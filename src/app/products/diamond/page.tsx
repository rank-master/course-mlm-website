// src/app/products/diamond/page.tsx
'use client';
import Link from 'next/link';
import Navbar from '../../../components/Navbar';
import Footer from '../../../components/Footer';

export default function DiamondCourse() {
  return (
      ...
      <div className="pt-20 pb-8 px-4 sm:px-6 max-w-3xl mx-auto relative z-10">
        <div className="bg-white shadow-lg rounded-lg p-8 border-l-8 border-yellow-600">
          ...
          <h1 className="text-4xl font-extrabold text-yellow-600 mb-2 tracking-wide">
            Instagram Growth Bundle (Diamond)
          </h1>
          <p className="text-3xl font-bold text-pink-500 mb-6">₹300</p>
          ...
          <div className="mb-8">
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-3">
                ...
                <span>All Gold + Bronze Content</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-4 h-4 bg-yellow-200 rounded-full mt-1"></span>
                <span>Growth Mastery Guide</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-4 h-4 bg-yellow-200 rounded-full mt-1"></span>
          ...
          <div className="flex justify-center mb-8">
            <Link
              href="https://wa.me/9707839680?text=I%20want%20to%20buy%20Instagram%20Growth%20(Diamond)%20for%20%E2%82%B9300"
              target="_blank"
